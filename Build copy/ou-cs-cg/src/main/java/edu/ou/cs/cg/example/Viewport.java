...
//******************************************************************************
// Last modified: Tue Dec 15 12:32:02 2020 by Chris Weaver
//******************************************************************************
	...
	implements GLEventListener, Runnable
{
											 ...
											 float ymin, float ymax)
	{
		...
		//gl.glViewport(20, 20, w-80, h-80);		// Active, pegged to canvas
		//gl.glViewport(20+k, 20+k, 200, 200);		// Dynamic, with animation
		gl.glViewport(20+(k%(w-40)), 20+(k%(h-40)), 20+(k%200), 200);		// Dynamic, with animation
	}
